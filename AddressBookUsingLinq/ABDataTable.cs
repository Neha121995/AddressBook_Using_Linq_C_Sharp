...
namespace AddressBookUsingLinq
{
    class ABDataTable
    {
        ...
        public DataTable CreateTable(AddressBookModel model)
        {
            ...
            dataTable.Rows.Add("Neha", "Jagtap", "Satara", "Satara", "Mh", "415001", "9476236457", "neha@gmail.com");
            dataTable.Rows.Add("Nikita", "Jadhav", "Kolhapur", "Kolhapur", "Mh", "411529", "7898765473", "nikita@gmail.com");
            return dataTable;
        }
